...
if __name__ == "__main__":
    timerDecision = int(input('How would you like to study today?\n'
    ...
    FocusTimer.timer(fm_study[timerDecision], fm_short_breaks[timerDecision], fm_long_breaks[timerDecision], countSB)
